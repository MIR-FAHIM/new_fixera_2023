...
class VendorProfileStatus1 extends StatefulWidget {
  const VendorProfileStatus1({Key? key}) : super(key: key);

  @override
  _VendorProfileStatus1State createState() => _VendorProfileStatus1State();
}

class _VendorProfileStatus1State extends State<VendorProfileStatus1> {
  ...
  var vendorProfileSettingUrl =
      "https://www.fix-era.com/api/v1/webview/vendor/profile?token=";


  @override
  Widget build(BuildContext context) {
    print("IIIIIII AMMMMMMM VEEEEENDORRRRRRRRRRR");
    return WillPopScope(
      onWillPop: () {
        Get.to(SignInPage());
        var a ;
