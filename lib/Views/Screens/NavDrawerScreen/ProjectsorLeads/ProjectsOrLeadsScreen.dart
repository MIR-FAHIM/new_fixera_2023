                        ...
                        child: InAppWebView(
                          ...
                          initialUrl:
                              userMap!["user_info"]["role_name"] == "contractor"
                                  ? AppUrl.contractorManageJobsUrl +
                                      SharedPref.to.prefss!.getString("token")!
                                  : AppUrl.leadManageJobsUrl +
                                      SharedPref.to.prefss!.getString("token")!,
                    ...
                    Expanded(
                      child: Container(
                        child: InAppWebView(
                          ...
                          initialUrl:
                              userMap!["user_info"]["role_name"] == "contractor"
                                  ? AppUrl.projectsOngoingUrl +
                                      SharedPref.to.prefss!.getString("token")!
                                  : AppUrl.leadOngoingUrl +
                                      SharedPref.to.prefss!.getString("token")!,
                          initialOptions: InAppWebViewGroupOptions(
                            crossPlatform: InAppWebViewOptions(
                                debuggingEnabled: true,
                    ...
                    Expanded(
                      child: Container(
                        child: InAppWebView(
                          ...
                          initialUrl:
                              userMap!["user_info"]["role_name"] == "contractor"
                                  ? AppUrl.projectsCompletedUrl +
                                      SharedPref.to.prefss!.getString("token")!
                                  : AppUrl.leadCompletedUrl +
                                      SharedPref.to.prefss!.getString("token")!,
                          initialOptions: InAppWebViewGroupOptions(
                            crossPlatform: InAppWebViewOptions(
                                debuggingEnabled: true,
