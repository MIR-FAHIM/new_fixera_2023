...
class ContractorExperienceEduInappwebview extends StatefulWidget {


  @override
  _ContractorExperienceEduInappwebviewState createState() => _ContractorExperienceEduInappwebviewState();
}

class _ContractorExperienceEduInappwebviewState extends State<ContractorExperienceEduInappwebview> {
  InAppWebViewController? _webViewController;
  double progress=0;

  var experiemnceAndEduUrl =
      "https://www.fix-era.com/api/v1/webview/contractor/dashboard/experience-education?token=";
...
/*          Container(
            ...
            Expanded(
              child: InAppWebView(
                ...
                initialUrl: experiemnceAndEduUrl+SharedPref.to.prefss!.getString("token")!,
