...
class ContractorProjectsCertificationInappWebView extends StatefulWidget {
  @override
  _ContractorProjectsCertificationInappWebViewState createState() =>
      _ContractorProjectsCertificationInappWebViewState();
}

class _ContractorProjectsCertificationInappWebViewState
    extends State<ContractorProjectsCertificationInappWebView> {
  InAppWebViewController? _webViewController;
  double progress=0;

  var projectCertificateUrl =
      "https://www.fix-era.com/api/v1/webview/contractor/dashboard/project-awards?token=";
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          title: Text("Projects & Certifications"),
        ),
        body: Column(
          children: [
/*          Container(
            ...
            Expanded(
              child: InAppWebView(
                ...
                initialUrl: projectCertificateUrl +
              ...
              // InAppWebView(
              //   initialHeaders: MyApiClient.header2(),
              //   initialUrl: projectCertificateUrl+SharedPref.to.prefss.getString("token"),
              //   initialOptions: InAppWebViewGroupOptions(
              //     crossPlatform: InAppWebViewOptions(
              //         debuggingEnabled: true,
              //         javaScriptCanOpenWindowsAutomatically: true,
