...
class WorkOrderContractorPage extends StatefulWidget {
  WorkOrderContractorPage({Key? key}) : super(key: key);

  @override
  _WorkOrderContractorPageState createState() =>
      _WorkOrderContractorPageState();
}

class _WorkOrderContractorPageState extends State<WorkOrderContractorPage> {
  @override
                        ...
                        child: DataTable(
                            ...
                            rows: <DataRow>[
                              DataRow(
                                  ...
                                  cells: <DataCell>[
                                    DataCell(Text('Item 01')),
                                    DataCell(Text('Description 01')),
                                    DataCell(Text('0')),
                                    DataCell(Text('0')),
                                    DataCell(Text('0.00')),
                                  ]),
