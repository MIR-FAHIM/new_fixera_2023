...
class _ManageAccountState extends State<ManageAccount> {
  var payment_setting_url =
      "https://www.fix-era.com/api/v1/webview/profile/settings/manage-account?token=";
  ...
  Widget build(BuildContext context) {
    print("The token is on the manage account  ${MyApiClient.header2()}");
    print("The token is");
...
/*          Container(
            ...
            Expanded(
              child: InAppWebView(
                ...
                initialUrl: payment_setting_url+ SharedPref.to.prefss!.getString("token")!,
