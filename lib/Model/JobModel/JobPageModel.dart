...
//
//     final jobPageModel = jobPageModelFromJson(jsonString);

import 'dart:convert';

JobPageModel jobPageModelFromJson(String str) =>
    JobPageModel.fromJson(json.decode(str));

String jobPageModelToJson(JobPageModel data) => json.encode(data.toJson());
...
class JobPageModel {
  ...
  factory JobPageModel.fromJson(Map<String, dynamic> json) => JobPageModel(
        error: json["error"],
