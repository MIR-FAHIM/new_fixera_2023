...
//
//     final vendorPageModel = vendorPageModelFromJson(jsonString);

import 'dart:convert';

VendorPageModel vendorPageModelFromJson(String str) => VendorPageModel.fromJson(json.decode(str));

String vendorPageModelToJson(VendorPageModel data) => json.encode(data.toJson());
...
class VendorPageModel {
    ...
    factory VendorPageModel.fromJson(Map<String, dynamic> json) => VendorPageModel(
        error: json["error"],
